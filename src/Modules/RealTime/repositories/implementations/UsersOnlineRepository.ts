...
class UsersOnlineRepository implements IUsersOnlineRepository {
 ...
 async create({ 
  ...
  update({idAccount, username, type, sexualOption, nickname, avatar, relationship, lat, long, city, uf, actualCity, actualUf, equalCity, plane, emoji, song, invisible,}):void {}
}
