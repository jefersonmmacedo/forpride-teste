...
class AccountsRepository implements IAccountsRepository {
  ...
  async create({ id, país, username, age, maxAge, minAge, role, status, viweSex, sex,
    sexualOption, 
    viewSexualOption, 
    preference, 
    preferenceOption,
    ...
    latitude, longitude, recommendation }: IAccountsDTO) {
    const account: Accounts = new Accounts();
     
      Object.assign(account, {
        id, _id: id, país, username, age, maxAge, minAge, role, status, viweSex, sex,
        sexualOption, 
        viewSexualOption, 
        preference, 
        preferenceOption,
        birthDate, sign, email, phone, password, online, patron,
        nickname, avatar, cover, relationship, city, uf, cep,
        latitude, longitude, recommendation ,created_at: new Date(),
      });
  ...
  update({ id, país, username, age, maxAge, minAge, role, status, viweSex, 
    sexualOption, 
    viewSexualOption, 
    preference, 
    preferenceOption,
    birthDate, sign, email, phone, password, online, patron,
    nickname, avatar, cover, relationship, city, uf, cep,
    latitude, longitude, recommendation}):void {}
