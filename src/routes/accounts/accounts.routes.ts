...
import { updateAvatarController } from "../../Modules/Accounts/useCases/updateAvatar";
import { updatePreferenceAccountController } from "../../Modules/Accounts/useCases/updatePreferenceAccount";
...
groupsAccounts.patch("/avatar/:id", (req, res) => {
  return updateAvatarController.handle(req, res);
});
groupsAccounts.patch("/preferences/:id", (req, res) => {
  return updatePreferenceAccountController.handle(req, res);
});
